...
- Added missing default and require exports in `package.json` for `@pandaf/core`, `@pandaf/vue`, and `@pandaf/react` to support ESM and CJS consumers.

## [0.1.1] - 2026-07-22

### Fixed

- Added 'package.json' export fields for `@pandaf/core`, `@pandaf/vue`, and `@pandaf/react` to support ESM and CJS consumers.
